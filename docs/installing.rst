...
You need to install the required packages. Using apt, you should execute::
    ...
    sudo apt-get install python-setuptools python-apt python-sphinx python-pylons python-debian python-sqlalchemy lintian dpkg-dev python-nose python-pybabel
