...
<h3>How do I build a package?</h3>
	...
	<p>If you want to learn how to create a proper Debian package you can find some interesting literature for starters at:</p>
...
<h3>Why do I not get a confirmation email?</h3>
